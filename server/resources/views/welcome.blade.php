...
<body class="flex justify-center items-center h-screen w-full relative overflow-hidden font-sans"
    style="background: url('https://job-order.smctgroup.ph/engine.jpg')">
    ...
    <section class="relative py-20 lg:py-32 bg-gradient-to-br from-primary/5 via-background to-secondary/5">
        <div class="container px-4 md:px-6">
            <div class="flex flex-col items-center space-y-8 text-center">
                <img src="https://job-order.smctgroup.ph/logo.png" alt="Company Logo" class="h-46 w-auto" />
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="https://job-order.smctgroup.ph"
