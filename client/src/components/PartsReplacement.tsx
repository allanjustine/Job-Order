...
export default function PartsReplacementSection({
  ...
  const partsItems: PartsItem[] = [
    { key: 'engineOil', label: 'Engine Oil' },
    { key: 'drainPlugWasher', label: 'Drain Plug Washer (12mm / 8 mm)' },
    ...
    { key: 'gaskets', label: 'Gaskets (Head, Right, Left, Others)' },
    ...
    { key: 'rubberPartsOilSeal', label: 'Rubber Parts / Oil Seal' },
  ...
  return (
    <div className="bg-gray-50 p-4 rounded-md">
      ...
      <div className="space-y-2">
        {partsItems.map((item) => (
          <div key={item.key} className="flex items-center justify-between gap-4">
            <Label onCheck className="flex-1">
              <Input
                type="checkbox"
                checked={partsReplacement[item.key as keyof PartsReplacement] as boolean}
                onChange={(e) =>
                  setPartsReplacement({
                    ...partsReplacement,
            ...
            {partsReplacement[item.key as keyof PartsReplacement] as boolean && (
              <div className="w-40">
                <div className="relative">
                  ...
                  <Input
                    type="number"
                    placeholder="0.00"
                    value={partsAmounts[item.key as keyof PartsAmountsType] || ''}
                    onChange={(e) => 
                      handlePartsAmountChange(
            ...
            <div className="w-40">
              <div className="relative">
                ...
                <Input
                  ...
                  onChange={(e) => handlePartsAmountChange('partsOthers', Number(e.target.value))}
                  min="0"
                  step="0.01"
                  className="pl-8 pr-3 text-right"
                />
        ...
        {(Object.values(partsReplacement).some(val => val === true) || partsTotal > 0) && (
