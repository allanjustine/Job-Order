  ...
  return (
    <div className="p-6 font-sans" style={{ fontSize: "12pt" }}>
      ...
      <div className="mb-4">
        ...
        <p>
          <strong>Vehicle Model:</strong> {data.vehicleModel}
        </p>
        <p>
          <strong>Chassis/Engine #:</strong> {data.chassis}
        </p>
        <p>
          <strong>Dealer/Brand Purchase:</strong> {data.dealer}
        </p>
      </div>
      ...
      <div className="mb-4">
        ...
        <p>
          <strong>Repair Job Start (time/date):</strong> {data.repairStart}
        </p>
        <p>
          <strong>Repair Job End (time/date):</strong> {data.repairEnd}
        </p>
      </div>
      ...
      <div className="mb-4">
        ...
        <ul className="list-none pl-0">
          ...
          <li
            className={data.documents.warrantyGuideBook ? "" : "text-gray-400"}
          >
            {data.documents.warrantyGuideBook ? "✓" : "☐"} Warranty Guide Book
          </li>
          <li className={data.documents.others ? "" : "text-gray-400"}>
            {data.documents.others ? "✓" : "☐"} Others:{" "}
            {data.documents.othersText}
          </li>
        </ul>
      </div>
