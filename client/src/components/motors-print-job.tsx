    ...
    >
      ...
      >
        ...
        <div className="border border-black p-0.5">
          ...
          <div className="flex mt-1">
            ...
            <span className="border-b border-black flex-1 overflow-hidden text-ellipsis whitespace-nowrap">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td className="border border-black p-0.5">
                <div className="flex items-center">
                  <span className="w-6">
                    {renderCheckbox(data.partsReplacement.engineOil)}
                  </span>
            ...
            <tr>
              <td className="border border-black p-0.5">
                <div className="flex items-center">
                  <span className="w-6">
                    {renderCheckbox(data.jobRequest.changeOil)}
                  </span>
                  <span>Charge Oil / Tune-up</span>
                </div>
              </td>
              <td className="border border-black p-0.5 text-left">
                {formatCurrency(getJobAmount("changeOil"))}
              </td>
              <td className="border border-black p-0.5">
                <div className="flex items-center">
                  <span className="w-6">
                    {renderCheckbox(data.partsReplacement.drainPlugWasher)}
                  </span>
            ...
            <tr>
              <td className="border border-black p-0.5">
                <div className="flex items-center">
                  <span className="w-6">
                    {renderCheckbox(data.jobRequest.overhaul)}
                  </span>
                  <span>Top / Major Overhaul</span>
                </div>
              </td>
              <td className="border border-black p-0.5 text-left">
                {formatCurrency(getJobAmount("overhaul"))}
              </td>
              <td className="border border-black p-0.5">
                <div className="flex items-center">
                  <span className="w-6">
                    {renderCheckbox(data.partsReplacement.tappetORing)}
                  </span>
            ...
            <tr>
              <td className="border border-black p-0.5">
                <div className="flex items-center">
                  <span className="w-6">
                    {renderCheckbox(data.jobRequest.chainSprocket)}
                  </span>
                  <span>Chain & Sprocket / Drive Belt</span>
                </div>
              </td>
              <td className="border border-black p-0.5 text-left">
                {formatCurrency(getJobAmount("chainSprocket"))}
              </td>
              <td className="border border-black p-0.5">
                <div className="flex items-center">
                  <span className="w-6">
                    {renderCheckbox(data.partsReplacement.sparkPlug)}
                  </span>
            ...
            <tr>
              <td className="border border-black p-0.5">
                <div className="flex items-center">
                  <span className="w-6">
                    {renderCheckbox(data.jobRequest.carburetor)}
                  </span>
                  <span>Carburetor / Fuel Injection</span>
                </div>
              </td>
              <td className="border border-black p-0.5 text-left">
                {formatCurrency(getJobAmount("carburetor"))}
              </td>
              <td className="border border-black p-0.5">
                <div className="flex items-center">
                  <span className="w-6">
                    {renderCheckbox(data.partsReplacement.airCleanerElement)}
                  </span>
            ...
            <tr>
              <td className="border border-black p-0.5">
                <div className="flex items-center">
                  <span className="w-6">
                    {renderCheckbox(data.jobRequest.brakeSystem)}
                  </span>
                  <span>Brake System (FR / RR)</span>
                </div>
              </td>
              <td className="border border-black p-0.5 text-left">
                {formatCurrency(getJobAmount("brakeSystem"))}
              </td>
              <td className="border border-black p-0.5">
                <div className="flex items-center">
                  <span className="w-6">
                    {renderCheckbox(data.partsReplacement.brakeShoePads)}
                  </span>
            ...
            <tr>
              <td className="border border-black p-0.5">
                <div className="flex items-center">
                  <span className="w-6">
                    {renderCheckbox(data.jobRequest.steeringSystem)}
                  </span>
                  <span>Steering System</span>
                </div>
              </td>
              <td className="border border-black p-0.5 text-left">
                {formatCurrency(getJobAmount("steeringSystem"))}
              </td>
              <td className="border border-black p-0.5">
                <div className="flex items-center">
                  <span className="w-6">
                    {renderCheckbox(data.partsReplacement.gaskets)}
                  </span>
            ...
            <tr>
              <td className="border border-black p-0.5">
                <div className="flex items-center">
                  <span className="w-6">
                    {renderCheckbox(data.jobRequest.suspensionSystem)}
                  </span>
                  <span>Suspension System (FR / RR) / Swing Arm</span>
                </div>
              </td>
              <td className="border border-black p-0.5 text-left">
                {formatCurrency(getJobAmount("suspensionSystem"))}
              </td>
              <td className="border border-black p-0.5">
                <div className="flex items-center">
                  <span className="w-6">
                    {renderCheckbox(data.partsReplacement.battery)}
                  </span>
                  <span>Battery</span>
                </div>
              </td>
            ...
            <tr>
              <td className="border border-black p-0.5">
                <div className="flex items-center">
                  <span className="w-6">
                    {renderCheckbox(data.jobRequest.wheelsSpokes)}
                  </span>
                  <span>Wheel & Spokes (FR / RR)</span>
                </div>
              </td>
              <td className="border border-black p-0.5 text-left">
                {formatCurrency(getJobAmount("wheelsSpokes"))}
              </td>
              <td className="border border-black p-0.5">
                <div className="flex items-center">
                  <span className="w-6">
                    {renderCheckbox(data.partsReplacement.chainSprocketBelt)}
                  </span>
                  <span>Chain & Sprocket / Drive Belt</span>
                </div>
              </td>
            ...
            <tr>
              <td className="border border-black p-0.5">
                <div className="flex items-center">
                  <span className="w-6">
                    {renderCheckbox(data.jobRequest.wheelAdjustment)}
                  </span>
                  <span>Wheel Adjustment</span>
                </div>
              </td>
              <td className="border border-black p-0.5 text-left">
                {formatCurrency(getJobAmount("wheelAdjustment"))}
              </td>
              <td className="border border-black p-0.5">
                <div className="flex items-center">
                  <span className="w-6">
                    {renderCheckbox(data.partsReplacement.fuelHose)}
                  </span>
                  <span>Fuel Hose</span>
                </div>
              </td>
            ...
            <tr>
              <td className="border border-black p-0.5">
                <div className="flex items-center">
                  <span className="w-6">
                    {renderCheckbox(data.jobRequest.batteryCharging)}
                  </span>
                  <span>Battery Charging</span>
                </div>
              </td>
              <td className="border border-black p-0.5 text-left">
                {formatCurrency(getJobAmount("batteryCharging"))}
              </td>
              <td className="border border-black p-0.5">
                <div className="flex items-center">
                  <span className="w-6">
                    {renderCheckbox(data.partsReplacement.tiresTubesFlaps)}
                  </span>
            ...
            <tr>
              <td className="border border-black p-0.5">
                <div className="flex items-center">
                  <span className="w-6">
                    {renderCheckbox(data.jobRequest.minorElectrical)}
                  </span>
                  <span>Minor Electrical (Horn / Winker / Others)</span>
                </div>
              </td>
              <td className="border border-black p-0.5 text-left">
                {formatCurrency(getJobAmount("minorElectrical"))}
              </td>
              <td className="border border-black p-0.5">
                <div className="flex items-center">
                  <span className="w-6">
                    {renderCheckbox(data.partsReplacement.bulbs)}
                  </span>
                  <span>Bulbs</span>
                </div>
              </td>
            ...
            <tr>
              <td className="border border-black p-0.5">
                <div className="flex items-center">
                  <span className="w-6">
                    {renderCheckbox(data.jobRequest.majorElectrical)}
                  </span>
                  <span>Major Electrical (Charging / Ignition / Starting)</span>
                </div>
              </td>
              <td className="border border-black p-0.5 text-left">
                {formatCurrency(getJobAmount("majorElectrical"))}
              </td>
              <td className="border border-black p-0.5">
                <div className="flex items-center">
                  <span className="w-6">
                    {renderCheckbox(data.partsReplacement.bearings)}
                  </span>
                  <span>Bearings</span>
                </div>
              </td>
            ...
            <tr>
              <td className="border border-black p-0.5">
                <div className="flex items-center">
                  <span className="w-6">
                    {renderCheckbox(data.jobRequest.installAccessories)}
                  </span>
                  <span>Install Accessories</span>
                </div>
              </td>
              <td className="border border-black p-0.5 text-left">
                {formatCurrency(getJobAmount("installAccessories"))}
              </td>
              <td className="border border-black p-0.5">
                <div className="flex items-center">
                  <span className="w-6">
                    {renderCheckbox(data.partsReplacement.springs)}
                  </span>
                  <span>Springs</span>
                </div>
              </td>
            ...
            <tr>
              <td className="border border-black p-0.5">
                <div className="flex items-center">
                  <span className="w-6">
                    {renderCheckbox(data.jobRequest.generalCheckup)}
                  </span>
                  <span>General Check Up</span>
                </div>
              </td>
              <td className="border border-black p-0.5 text-left">
                {formatCurrency(getJobAmount("generalCheckup"))}
              </td>
              <td className="border border-black p-0.5">
                <div className="flex items-center">
                  <span className="w-6">
                    {renderCheckbox(data.partsReplacement.rubberPartsOilSeal)}
                  </span>
            ...
            <tr>
              <td className="border border-black p-0.5">
                <div className="flex items-center">
                  <span className="w-6">
                    {renderCheckbox(data.jobRequest.warrantyRepair)}
                  </span>
                  <span>Warranty Repair</span>
                </div>
              </td>
              <td className="border border-black p-0.5 text-left">
                {formatCurrency(getJobAmount("warrantyRepair"))}
              </td>
              <td className="border border-black p-0.5">
                <div className="flex items-center">
                  <span className="w-6">
                    {renderCheckbox(data.partsReplacement.plasticParts)}
                  </span>
            ...
            <tr>
              <td className="border border-black p-0.5">
                <div className="flex items-center">
                  <span className="w-6">
                    {renderCheckbox(data.jobRequest.others)}
                  </span>
                  <span>Others: {data.jobRequest.othersText}</span>
                </div>
              </td>
              <td className="border border-black p-0.5 text-left">
                {formatCurrency(getJobAmount("others"))}
              </td>
              <td className="border border-black p-0.5">
                <div className="flex items-center">
                  <span className="w-6">
                    {renderCheckbox(data.partsReplacement.brakeFluid)}
                  </span>
            ...
            <tr>
              ...
              <td className="border border-black p-0.5">
                <div className="flex items-center">
                  <span className="w-6">
                    {renderCheckbox(data.partsReplacement.coolant)}
                  </span>
                  <span>Coolant</span>
                </div>
              </td>
            ...
            <tr>
              ...
              <td className="border border-black p-0.5">
                <div className="flex items-center">
                  <span className="w-6">
                    {renderCheckbox(data.partsReplacement.partsOthers)}
                  </span>
      ...
      >
        <div className="text-center  p-0.5">
          <div className=" mb-0.5 pb-1 h-4"></div>
          <p className="text-xs mb-0.5 text-left">Prepared by:</p>
          <p className="underline" style={{ fontStyle: "underline" }}>
            {data.serviceAdvisor}
          </p>
        ...
        <div className="text-center p-0.5">
          <div className=" mb-0.5 pb-1 h-4"></div>
          <p className="text-xs mb-0.5 text-left">Checked by:</p>
          <p className="underline" style={{ fontStyle: "underline" }}>
            {data.branchManager}
          </p>
          <p className="text-xs text-gray-600" style={{ fontSize: "7pt" }}>
        ...
        <div className="text-center  p-0.5">
          <div className=" mb-0.5 pb-1 h-4"></div>
          <p className="text-xs mb-0.5 text-left">Conformed by:</p>
          <p className="underline" style={{ fontStyle: "underline" }}>
            {data.customerName}
          </p>
          <p className="text-xs text-gray-600" style={{ fontSize: "7pt" }}>
