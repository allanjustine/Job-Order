...
const TicketCategories = () => {
    ...
    },
    {
      ...
      cell: (row: any) => (
        <div className="flex items-center gap-2">
          ...
          <Button
            type="button"
            onClick={handleDeleteTicketCategories(row?.id)}
  ...
  function handleDeleteTicketCategories(id: number) {
    return function () {
      Swal.fire({
        title: "Are you sure?",
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between p-6 gap-4">
            <div>
              ...
              <p className="text-sm text-gray-400 mt-0.5">
                Job Order Printing System — Ticket Categories Overview
              </p>
            </div>
